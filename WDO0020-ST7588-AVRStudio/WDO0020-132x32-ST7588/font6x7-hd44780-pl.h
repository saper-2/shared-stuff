...
// font size
#define GPH_CHAR_WIDTH 6
#define GPH_CHAR_HEIGHT 8
// in reality it's 6x8 :)

#define GPH_CHAR_START 32
#define GPH_CHAR_COUNT 108 // chars count in array

#define GPH_FONT_NAME g_font6x7
...
const __flash uint8_t g_font6x7[] = {
	...
	0x08, 0x3e, 0x48, 0x40, 0x20, 0x00, // 0x74 - [ t ]
	...
	// lines below you can comment if those char's are not needed
	,0x06, 0x09, 0x09, 0x06, 0x00, 0x00// 0x7f - degree
	,0x1c, 0x0a, 0x09, 0x6a, 0x5c, 0x00// 0x80 - [ • ]
	,0x38, 0x44, 0x46, 0x45, 0x28, 0x00// 0x81 - [ ∆ Ê ]
	,0x1f, 0x75, 0x55, 0x11, 0x00, 0x00// 0x82 - [   ]
	,0x7f, 0x48, 0x44, 0x40, 0x40, 0x00// 0x83 - [ £ ]
	,0x7c, 0x08, 0x12, 0x21, 0x7c, 0x00// 0x84 - [ — ]
	,0x38, 0x44, 0x46, 0x45, 0x38, 0x00// 0x85 - [ ” Û ]
	,0x48, 0x54, 0x56, 0x55, 0x20, 0x00// 0x86 - [ å ú ]
	,0x44, 0x64, 0x55, 0x4c, 0x44, 0x00// 0x87 - [ Ø ø ]
	,0x44, 0x64, 0x56, 0x4d, 0x44, 0x00// 0x88 - [ è ü ]
	,0x08, 0x15, 0x75, 0x55, 0x1e, 0x00// 0x89 - [ π ]
	,0x0e, 0x15, 0x75, 0x55, 0x02, 0x00// 0x8a - [ Í ]
	,0x00, 0x51, 0x7f, 0x44, 0x00, 0x00// 0x8b - [ ≥ ]
	,0x7c, 0x08, 0x06, 0x05, 0x78, 0x00// 0x8c - [ Ò ]
};
